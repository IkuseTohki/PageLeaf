    ...
    public class CheatSheetViewModel : ViewModelBase
    {
        ...
        private static System.Collections.Generic.IEnumerable<CheatSheetItem> GetMarkdownItems()
        {
            return new[]
            {
                ...
                new CheatSheetItem { Category = "強調", Syntax = "~~取り消し~~", Description = "取り消し線", RelatedShortcut = "Ctrl + Shift + X" },
        ...
        private static System.Collections.Generic.IEnumerable<CheatSheetItem> GetShortcutItems()
        {
            return new[]
            {
                ...
                new CheatSheetItem { Category = "編集操作", Syntax = "Ctrl + L", Description = "タスクリストのトグル" },
                new CheatSheetItem { Category = "表示操作", Syntax = "Shift + Alt + ←/→", Description = "編集/プレビューモード切替" },
